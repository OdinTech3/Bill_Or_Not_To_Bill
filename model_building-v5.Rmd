...
# save(history, file = "data/history_model_v5.RData")
# save_model_hdf5(model, filepath = "data/fitted_model_v5")
# save_model_weights_hdf5(model, filepath = "data/fitted_model_v5_weights")
```
...
```{r}
pred_class <- as.numeric(pred_probs > .40) %>% as.factor()
