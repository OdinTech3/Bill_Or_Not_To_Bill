...
```{r load-dataset, warning=F, message=F}
...
```{r}
call_text_word_index <- call_text_tokenizer$word_index

cat("Found", length(call_text_word_index), "unique tokens.\n")
```
...
```{r}
billing_notes_word_index <- billing_notes_tokenizer$word_index

cat("Found", length(billing_notes_word_index), "unique tokens.\n")
```
