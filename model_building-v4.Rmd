...
#save(history, file = "data/history_model_v4.RData")
#save_model_hdf5(model, filepath = "data/fitted_model_v4")
#save_model_weights_hdf5(model, filepath = "data/fitted_model_v4_weights")
```
