...
### 1.2 Splitting `Call Text` into Training and Test
...
### 1.2 Splitting `Billing Notes` into Training and Test
...
### 1.3 Splitting `Auxilary` Data into Training and Test
...
save(history, file = "data/history_model_v1.RData")
save_model_hdf5(model, filepath = "data/fitted_model_v1")
save_model_weights_hdf5(model, filepath = "data/fitted_model_v1_weights")
```
